...
public class CustomerRepository implements IRepository {
    ...
    private static final String SEARCH_CUSTOMER_SQL = "select id_khach_hang,ho_ten, email, dia_chi " +
            "from khach_hang " + "where ho_ten = ?";
    ;
    ...
    public List<Customer> selectAllUsers() {
        List<Customer> userCustomerList = new ArrayList<>();
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                userCustomerList.add(new Customer(id, name, ngaySinh, so_cmnd, sdt, email, dia_chi));
            }
    ...
    public Customer selectUser(int id) {
        ...
        try (Connection connection = getConnection();
            ...
            while (rs.next()) {
                ...
                String email = rs.getString("email");
                String dia_chi = rs.getString("dia_chi");
                userCustomer = (new Customer(id, name, ngaySinh, so_cmnd, sdt, email, dia_chi));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
    ...
    @Override
    public void insertUser(Customer newUser) {
    ...
    @Override
    public boolean updateUser(Customer userCustomer) throws SQLException {
        boolean rowUpdated;
    ...
    @Override
    public List<Customer> searchUser(String name) {
        List<Customer> userCustomers = new ArrayList<>();
        Customer userCustomeruser =null;
        try{
            ...
            while (resultSet.next()){
                ...
                userCustomeruser.setDia_chi(resultSet.getString("dia_chi"));
