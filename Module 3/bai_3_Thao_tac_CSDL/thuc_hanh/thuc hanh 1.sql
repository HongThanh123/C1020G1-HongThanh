...
create database and_or;
-- alter database truy_van_du_lieu modify name =  and_or;
...
-- lấy productcode, productname và buyprice từ bảng products,
-- textdescription từ bảng productlines với 
-- điều kiện giá mua nằm trong khoảng từ 56.76 đến 95.59
...
-- hiển thị ra các sản phẩm có loại sản phẩm 
-- là Classic Cars hoặc nhà cung cấp là 'Min Lin Diecast'
